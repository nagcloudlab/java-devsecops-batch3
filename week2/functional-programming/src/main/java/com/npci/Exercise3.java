...
// How to define data ==> OO concepts
// How to store data ==> collections
// How to process data functionally => Lambda + Stream API
// How to process data concurrently | parallaly => MultiThreading
