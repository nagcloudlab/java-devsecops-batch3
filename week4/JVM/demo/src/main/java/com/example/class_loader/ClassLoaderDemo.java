...
public class ClassLoaderDemo {
    public static void main(String[] args) {
        ...
        System.out.println("ClassLoader of ArrayList: " + java.util.ArrayList.class.getClassLoader());
        System.out.println("ClassLoader of javax.crypto.Cipher: " + javax.crypto.Cipher.class.getClassLoader());
